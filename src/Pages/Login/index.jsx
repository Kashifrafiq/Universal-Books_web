    ...
    if (email && password) {
      ...
      signInWithEmailAndPassword(auth, email, password)
        ...
        .catch((err) => {
          ...
          // Unified message for incorrect email or password
          if (
            err.code === "auth/user-not-found" ||
            err.code === "auth/wrong-password"
          ) {
            customMessage = "Your email or password is incorrect. Please try again.";
          } else if (err.code === "auth/too-many-requests") {
            customMessage = "Too many attempts. Please try again later.";
          }
  
          setErrorMsg(customMessage); // Set the custom error message
          alert(customMessage); // Optional alert for immediate feedback
          setIsSubmitting(false);
        });
    } else {
